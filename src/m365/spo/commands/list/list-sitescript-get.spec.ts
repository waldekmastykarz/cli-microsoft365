...
describe(commands.LIST_SITESCRIPT_GET, () => {
  ...
  it('extracts the site script from the given list if title option is passed (debug)',
    async () => {
  ...
  it('extracts the site script from the given list if title option is passed',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`https://contoso.sharepoint.com/sites/team1/_api/Microsoft_SharePoint_Utilities_WebTemplateExtensions_SiteScriptUtility_GetSiteScriptFromList`) > -1) {
          return {
  ...
  it('extracts the site script from the given list if list id option is passed (debug)',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`https://contoso.sharepoint.com/sites/team1/_api/Microsoft_SharePoint_Utilities_WebTemplateExtensions_SiteScriptUtility_GetSiteScriptFromList`) > -1) {
          return {
  ...
  it('extracts the site script from the given list if list id option is passed',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`https://contoso.sharepoint.com/sites/team1/_api/Microsoft_SharePoint_Utilities_WebTemplateExtensions_SiteScriptUtility_GetSiteScriptFromList`) > -1) {
          return {
  ...
  it('extracts the site script from the given list if url option is passed (debug)',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`https://contoso.sharepoint.com/sites/team1/_api/Microsoft_SharePoint_Utilities_WebTemplateExtensions_SiteScriptUtility_GetSiteScriptFromList`) > -1) {
          return {
  ...
  it('correctly handles error when trying to extract site script if the server did not return generated site script (using listId)',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`https://contoso.sharepoint.com/sites/team1/_api/Microsoft_SharePoint_Utilities_WebTemplateExtensions_SiteScriptUtility_GetSiteScriptFromList`) > -1) {
          return {
  ...
  it('correctly handles error when trying to extract site script if the server did not return generated site script (using listTitle)',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`https://contoso.sharepoint.com/sites/team1/_api/Microsoft_SharePoint_Utilities_WebTemplateExtensions_SiteScriptUtility_GetSiteScriptFromList`) > -1) {
          return {
  ...
  it('correctly handles error when trying to extract site script from a list that doesn\'t exist',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`https://contoso.sharepoint.com/sites/team1/_api/Microsoft_SharePoint_Utilities_WebTemplateExtensions_SiteScriptUtility_GetSiteScriptFromList`) > -1) {
          return {
