...
describe(commands.LIST, () => {
  ...
  it('fails validation if asAdmin is specified in combination with a sharingStatus',
    async () => {
  ...
  it('fails validation if sharingStatus is not a valid sharingstatus',
    async () => {
  ...
  it('retrieves available Flows when specifying sharingStatus ownedByMe',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
  ...
  it('retrieves available Flows when specifying sharingStatus all',
    async () => {
  ...
  it('retrieves available Flows when specifying sharingStatus personal',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if (opts.url === `https://management.azure.com/providers/Microsoft.ProcessSimple/environments/${environmentId}/flows?api-version=2016-11-01&$filter=search('personal')`) {
          return flowResponse;
  ...
  it('retrieves available Flows when specifying sharingStatus sharedWithMe',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if (opts.url === `https://management.azure.com/providers/Microsoft.ProcessSimple/environments/${environmentId}/flows?api-version=2016-11-01&$filter=search('team')`) {
          return flowResponse;
