...
describe(commands.FIELD_ADD, () => {
  ...
  it('creates list column using XML with the DefaultValue option (debug)',
    async () => {
      const output = {
        "AutoIndexed": false,
        "CanBeDeleted": true,
  ...
  it('creates site column using XML with the AddToAllContentTypes, AddFieldToDefaultView, AddFieldCheckDisplayName options',
    async () => {
      const response = {
        "AutoIndexed": false,
        "CanBeDeleted": true,
  ...
  it('creates site column using XML with the AddToDefaultContentType, AddFieldInternalNameHint options',
    async () => {
      const response = {
        "AutoIndexed": false,
        "CanBeDeleted": true,
  ...
  it('creates site column using XML with the AddToNoContentType option',
    async () => {
      const response = {
        "AutoIndexed": false,
        "CanBeDeleted": true,
  ...
  it('creates list column to list retrieved by ID using XML with the DefaultValue option',
    async () => {
      const output = {
        "AutoIndexed": false,
        "CanBeDeleted": true,
  ...
  it('creates list column to list retrieved by list URL using XML with the DefaultValue option',
    async () => {
