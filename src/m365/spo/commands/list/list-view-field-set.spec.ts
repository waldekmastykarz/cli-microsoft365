...
describe(commands.LIST_VIEW_FIELD_SET, () => {
  ...
  it('fails validation if the position option is defined and is not a valid number',
    async () => {
  ...
  it('moves the field by title to the position index to viewTitle of listId',
    async () => {
      stubAllGetRequests();
  ...
  it('moves the field by title to the position index to viewId of listTitle (debug)',
    async () => {
      stubAllGetRequests();
  ...
  it('moves the field by id to the position index to viewId of listTitle',
    async () => {
      stubAllGetRequests();
  ...
  it('moves the field by id to the position index to viewTitle of listId (debug)',
    async () => {
      stubAllGetRequests();
  ...
  it('moves the field by id to the position index to viewTitle of listUrl',
    async () => {
      stubAllGetRequests();
