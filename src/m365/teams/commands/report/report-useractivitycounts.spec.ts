...
import command from './report-useractivitycounts.js';
...
describe(commands.REPORT_USERACTIVITYCOUNTS, () => {
  ...
  it('gets the number of Microsoft Teams activities by activity type for the given period',
    async () => {
      ...
      assert.strictEqual(requestStub.mock.lastCall[0].url, "https://graph.microsoft.com/v1.0/reports/getTeamsUserActivityCounts(period='D7')");
