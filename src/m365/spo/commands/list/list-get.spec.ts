...
describe(commands.LIST_GET, () => {
  ...
  it('retrieves and prints all details of list if title option is passed',
    async () => {
  ...
  it('retrieves details of list if title and properties option is passed (debug)',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().resolves({
        "Id": "14b2b6ed-0885-4814-bfd6-594737cc3ae3",
        "Title": "Documents"
  ...
  it('retrieves details of list if list id and properties option is passed (debug)',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().resolves(
        {
          "Id": "14b2b6ed-0885-4814-bfd6-594737cc3ae3",
  ...
  it('retrieves details of list if url and properties option is passed (debug)',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().resolves(
        {
          "Id": "14b2b6ed-0885-4814-bfd6-594737cc3ae3",
  ...
  it('retrieves details of list if list id and withPermissions option is passed',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().resolves({
        "RoleAssignments": [
          {
  ...
  it('retrieves details of list if list id, properties and withPermissions option is passed',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().resolves(
        {
          "RoleAssignments": [
  ...
  it('retrieves details of list if list title, properties and withPermissions option is passed',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().resolves({
        "RoleAssignments": [
          {
