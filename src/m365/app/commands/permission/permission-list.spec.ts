...
describe(commands.PERMISSION_LIST, () => {
  ...
  it('retrieves permissions from app registration if service principal not found',
    async () => {
      ...
      assert.strictEqual(JSON.stringify(loggerLogSpy.mock.lastCall[0]), JSON.stringify([
        {
  ...
  it('retrieves permissions from app registration if service principal not found (debug)',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        switch (opts.url) {
          case `https://graph.microsoft.com/v1.0/servicePrincipals?$filter=appId eq '9c79078b-815e-4a3e-bb80-2aaf2d9e9b3d'&$select=appId,id,displayName`:
  ...
  it(`doesn't fail when the app registration has no API permissions`,
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        switch (opts.url) {
          case `https://graph.microsoft.com/v1.0/servicePrincipals?$filter=appId eq '9c79078b-815e-4a3e-bb80-2aaf2d9e9b3d'&$select=appId,id,displayName`:
  ...
  it('retrieves permissions for a service principal with delegated and app permissions',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        switch (opts.url) {
          case `https://graph.microsoft.com/v1.0/servicePrincipals?$filter=appId eq '9c79078b-815e-4a3e-bb80-2aaf2d9e9b3d'&$select=appId,id,displayName`:
  ...
  it('retrieves permissions for a service principal with delegated and app permissions (debug)',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        switch (opts.url) {
          case `https://graph.microsoft.com/v1.0/servicePrincipals?$filter=appId eq '9c79078b-815e-4a3e-bb80-2aaf2d9e9b3d'&$select=appId,id,displayName`:
  ...
  it('retrieves permissions for a service principal with delegated permissions',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        switch (opts.url) {
          case `https://graph.microsoft.com/v1.0/servicePrincipals?$filter=appId eq '9c79078b-815e-4a3e-bb80-2aaf2d9e9b3d'&$select=appId,id,displayName`:
  ...
  it('handles error when retrieving service principal for the AAD app',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        switch (opts.url) {
          case `https://graph.microsoft.com/v1.0/servicePrincipals?$filter=appId eq '9c79078b-815e-4a3e-bb80-2aaf2d9e9b3d'&$select=appId,id,displayName`:
  ...
  it('handles error when retrieving OAuth2 permission grants for service principal',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        switch (opts.url) {
          case `https://graph.microsoft.com/v1.0/servicePrincipals?$filter=appId eq '9c79078b-815e-4a3e-bb80-2aaf2d9e9b3d'&$select=appId,id,displayName`:
  ...
  it('handles error when retrieving OAuth2 permission scopes for service principal',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        switch (opts.url) {
          case `https://graph.microsoft.com/v1.0/servicePrincipals?$filter=appId eq '9c79078b-815e-4a3e-bb80-2aaf2d9e9b3d'&$select=appId,id,displayName`:
  ...
  it('handles error when retrieving app role assignments for service principal',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        switch (opts.url) {
          case `https://graph.microsoft.com/v1.0/servicePrincipals?$filter=appId eq '9c79078b-815e-4a3e-bb80-2aaf2d9e9b3d'&$select=appId,id,displayName`:
  ...
  it('handles error when retrieving app roles for service principal',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        switch (opts.url) {
          case `https://graph.microsoft.com/v1.0/servicePrincipals?$filter=appId eq '9c79078b-815e-4a3e-bb80-2aaf2d9e9b3d'&$select=appId,id,displayName`:
  ...
  it('handles non-existent service principal from app registration permissions',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        switch (opts.url) {
          case `https://graph.microsoft.com/v1.0/servicePrincipals?$filter=appId eq '9c79078b-815e-4a3e-bb80-2aaf2d9e9b3d'&$select=appId,id,displayName`:
  ...
  it('handles service principal referencing a non-existent app permission',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        switch (opts.url) {
          case `https://graph.microsoft.com/v1.0/servicePrincipals?$filter=appId eq '9c79078b-815e-4a3e-bb80-2aaf2d9e9b3d'&$select=appId,id,displayName`:
  ...
  it('handles unknown delegated permissions from app registration',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        switch (opts.url) {
          case `https://graph.microsoft.com/v1.0/servicePrincipals?$filter=appId eq '9c79078b-815e-4a3e-bb80-2aaf2d9e9b3d'&$select=appId,id,displayName`:
  ...
  it('handles unknown application permissions from app registration',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        switch (opts.url) {
          case `https://graph.microsoft.com/v1.0/servicePrincipals?$filter=appId eq '9c79078b-815e-4a3e-bb80-2aaf2d9e9b3d'&$select=appId,id,displayName`:
