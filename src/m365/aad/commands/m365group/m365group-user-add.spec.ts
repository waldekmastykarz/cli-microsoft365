...
describe(commands.M365GROUP_USER_ADD, () => {
  ...
  it('fails validation if neither the groupId nor teamId are provided.',
    async () => {
  ...
  it('passes validation when valid groupId, userName and no role specified',
    async () => {
      const actual = await command.validate({
        options: {
          groupId: '6703ac8a-c49b-4fd4-8223-28f0ac3a6402',
  ...
  it('correctly retrieves user and add member to specified Microsoft 365 group',
    async () => {
  ...
  it('correctly retrieves user and add member to specified Microsoft 365 group (debug)',
    async () => {
      let addMemberRequestIssued = false;
  ...
  it('correctly retrieves user and add owner to specified Microsoft 365 group',
    async () => {
      let addMemberRequestIssued = false;
  ...
  it('correctly retrieves user and add owner to specified Microsoft Teams team (debug)',
    async () => {
      let addMemberRequestIssued = false;
  ...
  it('correctly skips adding member or owner when user is not found',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
  ...
  it('correctly retrieves user and handle error adding member to specified Microsoft 365 group',
    async () => {
