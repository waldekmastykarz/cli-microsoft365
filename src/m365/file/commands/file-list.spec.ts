...
describe(commands.LIST, () => {
  ...
  it('loads files from the root site collection without trailing slash, document library without space, root folder, matching case',
    async () => {
  ...
  it('loads files from the root site collection without trailing slash, document library without space, root folder, matching case (debug)',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('loads files from the root site collection with trailing slash, document library without space, root folder, matching case',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('loads files from the root site collection with trailing slash, document library without space, leading slash, root folder, matching case',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('loads files from the root site collection without trailing slash, document library without space, root folder, different case',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('loads files from the root site collection without trailing slash, document library with space, root folder',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('loads files from the root site collection without trailing slash, document library without space, subfolder',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('loads files from the root site collection without trailing slash, document library without space, subfolder with special chars',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('loads files from non-root site collection without trailing slash, document library without space, root folder',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('loads files from non-root site collection with trailing slash, document library without space, root folder',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('loads files from non-root site collection without trailing slash, document library without space, subfolder',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('loads files recursively from a folder with one level of subfolders',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('loads files recursively from a folder with multiple levels of subfolders',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('handles error when document library not found in the root site without trailing slash',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('handles error when document library not found in the root site with trailing slash',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
