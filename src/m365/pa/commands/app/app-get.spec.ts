...
describe(commands.APP_GET, () => {
  ...
  it('retrieves information about the specified app using name (debug)',
    async () => {
  ...
  it(`retrieves information about the specified app using displayName`,
    async () => {
      const apps = [
        {
  ...
  it('renders empty string for missing properties using displayName',
    async () => {
      const apps = [
        {
          "name": "4d4bb961-eef9-4258-8516-aa8d64e6b477",
