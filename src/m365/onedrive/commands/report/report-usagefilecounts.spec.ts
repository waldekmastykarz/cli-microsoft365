...
describe(commands.REPORT_USAGEFILECOUNTS, () => {
  ...
  it('has correct name', () => {
    assert.strictEqual(command.name, commands.REPORT_USAGEFILECOUNTS);
  });
  ...
  it('gets the report for the last week', async () => {
    ...
    assert.strictEqual(requestStub.mock.lastCall[0].url, "https://graph.microsoft.com/v1.0/reports/getOneDriveUsageFileCounts(period='D7')");
