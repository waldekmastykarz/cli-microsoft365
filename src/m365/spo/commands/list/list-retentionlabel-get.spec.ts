...
describe(commands.LIST_RETENTIONLABEL_GET, () => {
  ...
  it('gets the label from the given list if title option is passed (debug)',
    async () => {
  ...
  it('gets the label from the given list if title option is passed',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
  ...
  it('gets the label from the given list if list id option is passed (debug)',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`https://contoso.sharepoint.com/sites/team1/_api/SP_CompliancePolicy_SPPolicyStoreProxy_GetListComplianceTag`) > -1) {
          return {
  ...
  it('gets the label from the given list if list id option is passed',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`https://contoso.sharepoint.com/sites/team1/_api/SP_CompliancePolicy_SPPolicyStoreProxy_GetListComplianceTag`) > -1) {
          return {
  ...
  it('gets the label from the given list if url option is passed (debug)',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`https://contoso.sharepoint.com/sites/team1/_api/`) > -1) {
          return {
  ...
  it('correctly handles the case when no label has been set on the specified list',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`https://contoso.sharepoint.com/sites/team1/_api/SP_CompliancePolicy_SPPolicyStoreProxy_GetListComplianceTag`) > -1) {
          return {
  ...
  it('correctly handles error when trying to get label for the list',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`https://contoso.sharepoint.com/sites/team1/_api/SP_CompliancePolicy_SPPolicyStoreProxy_GetListComplianceTag`) > -1) {
          throw {
  ...
  it('correctly handles error when trying to get label from a list that doesn\'t exist',
    async () => {
      const error = {
        error: {
          'odata.error': {
