...
describe(commands.ENABLE, () => {
  ...
  it('enables the specified flow (debug)', async () => {
    ...
    assert.strictEqual(postStub.mock.lastCall[0].url, 'https://management.azure.com/providers/Microsoft.ProcessSimple/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c5/flows/3989cb59-ce1a-4a5c-bb78-257c5c39381d/start?api-version=2016-11-01');
  });
  ...
  it('enables the specified flow as admin', async () => {
    ...
    assert.strictEqual(postStub.mock.lastCall[0].url, 'https://management.azure.com/providers/Microsoft.ProcessSimple/scopes/admin/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c5/flows/3989cb59-ce1a-4a5c-bb78-257c5c39381d/start?api-version=2016-11-01');
  });
