...
describe(commands.PLAN_ADD, () => {
  ...
  it('correctly adds planner plan with given title with available ownerGroupId',
    async () => {
  ...
  it('correctly adds planner plan with given title with available rosterId',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if (opts.url === `https://graph.microsoft.com/v1.0/planner/plans`) {
  ...
  it('correctly handles adding planner plan to a roster with an already linked plan',
    async () => {
  ...
  it('correctly adds planner plan with given title with available ownerGroupName',
    async () => {
  ...
  it('correctly adds planner plan with given title with ownerGroupId and shareWithUserIds',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
  ...
  it('correctly adds planner plan with given title with ownerGroupId and shareWithUserNames',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if (opts.url === `https://graph.microsoft.com/v1.0/planner/plans/${validId}/details`) {
          return planDetailsEtagResponse;
