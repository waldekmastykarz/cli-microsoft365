...
import command, { options } from './groupsetting-list.js';
...
describe(commands.GROUPSETTING_LIST, () => {
  ...
  it('passes validation if no options are specified', () => {
    const actual = commandOptionsSchema.safeParse({});
    assert.strictEqual(actual.success, true);
  });

  it('fails validation if unknown options are specified', () => {
    const actual = commandOptionsSchema.safeParse({ unknownOption: true });
