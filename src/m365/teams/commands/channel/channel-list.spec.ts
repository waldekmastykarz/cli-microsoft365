...
describe(commands.CHANNEL_LIST, () => {
  ...
  it('correctly lists all channels in a Microsoft teams team by team id',
    async () => {
  ...
  it('correctly lists all channels in a Microsoft teams team with specified type parameter',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
  ...
  it('correctly lists all channels in a Microsoft teams team by team name',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`/v1.0/groups?$filter=displayName eq '`) > -1) {
          return {
  ...
  it('correctly lists all channels in a Microsoft teams team (debug)',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if (opts.url === `https://graph.microsoft.com/v1.0/teams/00000000-0000-0000-0000-000000000000/channels`) {
          return {
