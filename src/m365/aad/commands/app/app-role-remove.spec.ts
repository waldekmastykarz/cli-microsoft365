...
describe(commands.APP_ROLE_REMOVE, () => {
  ...
  it('deletes an app role when the role is in enabled state and valid appObjectId, role claim and --force option specified',
    async () => {
      ...
      const patchStub = jest.spyOn(request, 'patch').mockClear().mockImplementation();
  ...
  it('deletes an app role when the role is in enabled state and valid appObjectId, role name and --force option specified',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/applications/5b31c38c-2584-42f0-aa47-657fb3a84230?$select=id,appRoles') {
          return {
  ...
  it('deletes an app role when the role is in enabled state and valid appObjectId, role id and --force option specified',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/applications/5b31c38c-2584-42f0-aa47-657fb3a84230?$select=id,appRoles') {
          return {
  ...
  it('deletes an app role when the role is in enabled state and valid appId, role claim and --force option specified',
    async () => {
  ...
  it('deletes an app role when the role is in enabled state and valid appId, role name and --force option specified',
    async () => {
  ...
  it('deletes an app role when the role is in enabled state and valid appId, role id and --force option specified',
    async () => {
  ...
  it('deletes an app role when the role is in enabled state and valid appObjectId, role claim and --force option specified (debug)',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/applications/5b31c38c-2584-42f0-aa47-657fb3a84230?$select=id,appRoles') {
          return {
  ...
  it('deletes an app role when the role is in enabled state and valid appId, role name and --force option specified (debug)',
    async () => {
  ...
  it('deletes an app role when the role is in enabled state and valid appId, role id and --force option specified (debug)',
    async () => {
  ...
  it('deletes an app role when the role is in "disabled" state and valid appId, role id and --force option specified',
    async () => {
  ...
  it('deletes an app role when the role is in "disabled" state and valid appId, role claim and --force option specified',
    async () => {
  ...
  it('deletes an app role when the role is in "disabled" state and valid appId, role name and --force option specified',
    async () => {
  ...
  it('deletes an app role when the role is in "disabled" state and valid appId, role id and --force option specified (debug)',
    async () => {
  ...
  it('deletes an app role when the role is in "disabled" state and valid appId, role claim and --force option specified (debug)',
    async () => {
  ...
  it('deletes an app role when the role is in "disabled" state and valid appId, role name and --force option specified (debug)',
    async () => {
  ...
  it('handles error when multiple apps with the specified appName found and --force option is specified',
    async () => {
  ...
  it('handles when multiple roles with the same name are found and --confirm option specified',
    async () => {
      jest.spyOn(cli, 'getSettingWithDefaultValue').mockClear().mockImplementation((settingName, defaultValue) => {
        if (settingName === settingsNames.prompt) {
          return false;
  ...
  it('handles selecting single result when multiple roles with the specified name found and cli is set to prompt',
    async () => {
      let removeRequestIssued = false;
      const getRequestStub = jest.spyOn(request, 'get').mockClear().mockImplementation();
      ...
      jest.spyOn(Cli, 'handleMultipleResultsFound').mockClear().mockImplementation().resolves({ id: 'c4352a0a-494f-46f9-b843-479855c173a7' });
  ...
  it('handles when no roles with the specified name are found and --force option specified',
    async () => {
  ...
  it('handles when no roles with the specified claim are found and --force option specified',
    async () => {
  ...
  it('handles when no roles with the specified id are found and --force option specified',
    async () => {
  ...
  it('prompts before removing the specified app role when confirm option not passed',
    async () => {
  ...
  it('prompts before removing the specified app role when confirm option not passed (debug)',
    async () => {
  ...
  it('deletes an app role when the role is in enabled state and valid appObjectId, role claim and the prompt is confirmed (debug)',
    async () => {
  ...
  it('deletes an app role when the role is in enabled state and valid appId, role name and prompt is confirmed',
    async () => {
  ...
  it('deletes an app role when the role is in enabled state and valid appId, role id and prompt is confirmed (debug)',
    async () => {
  ...
  it('aborts deleting app role when prompt is not confirmed', async () => {
    ...
    const patchStub = jest.spyOn(request, 'get').mockClear().mockImplementation();
    jestUtil.restore(Cli.prompt);
  ...
  it('aborts deleting app role when prompt is not confirmed (debug)',
    async () => {
      // represents the aad app get request called when the prompt is confirmed
      const patchStub = jest.spyOn(request, 'get').mockClear().mockImplementation();
      jestUtil.restore(Cli.prompt);
