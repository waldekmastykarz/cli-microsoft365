...
describe(commands.CONTENTTYPE_FIELD_SET, () => {
  ...
  it('adds a field reference to content type updating field schema',
    async () => {
  ...
  it('adds a field reference to content type updating field schema (debug)',
    async () => {
      let fieldLinksRequestNum: number = 0;
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`_api/web/contenttypes('0x0100558D85B7216F6A489A499DB361E1AE2F')/fieldlinks('5ee2dd25-d941-455a-9bdb-7f2c54aed11b')`) > -1) {
  ...
  it('adds a field reference to content type updating field schema from AllowDeletion=FALSE',
    async () => {
      let fieldLinksRequestNum: number = 0;
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`_api/web/contenttypes('0x0100558D85B7216F6A489A499DB361E1AE2F')/fieldlinks('5ee2dd25-d941-455a-9bdb-7f2c54aed11b')`) > -1) {
  ...
  it('adds a field reference to content type without updating field schema',
    async () => {
      let fieldLinksRequestNum: number = 0;
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`_api/web/contenttypes('0x0100558D85B7216F6A489A499DB361E1AE2F')/fieldlinks('5ee2dd25-d941-455a-9bdb-7f2c54aed11b')`) > -1) {
  ...
  it('adds a field reference to content type without updating field schema (debug)',
    async () => {
      let fieldLinksRequestNum: number = 0;
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`_api/web/contenttypes('0x0100558D85B7216F6A489A499DB361E1AE2F')/fieldlinks('5ee2dd25-d941-455a-9bdb-7f2c54aed11b')`) > -1) {
  ...
  it('skips updating when existing field link is up-to-date (no values specified)',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`_api/web/contenttypes('0x0100558D85B7216F6A489A499DB361E1AE2F')/fieldlinks('5ee2dd25-d941-455a-9bdb-7f2c54aed11b')`) > -1) {
          return {
  ...
  it('skips updating when existing field link is up-to-date (no values specified; debug)',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`_api/web/contenttypes('0x0100558D85B7216F6A489A499DB361E1AE2F')/fieldlinks('5ee2dd25-d941-455a-9bdb-7f2c54aed11b')`) > -1) {
          return {
  ...
  it('handles error while retrieving request digest', async () => {
    ...
    jest.spyOn(spo, 'getRequestDigest').mockClear().mockImplementation(() => Promise.reject({ error: { 'odata.error': { message: { value: 'An error has occurred' } } } }));
    let fieldLinksRequestNum: number = 0;
    jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
      if ((opts.url as string).indexOf(`_api/web/contenttypes('0x0100558D85B7216F6A489A499DB361E1AE2F')/fieldlinks('5ee2dd25-d941-455a-9bdb-7f2c54aed11b')`) > -1) {
        fieldLinksRequestNum++;
