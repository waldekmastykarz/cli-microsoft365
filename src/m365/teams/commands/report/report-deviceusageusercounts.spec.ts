...
describe(commands.REPORT_DEVICEUSAGEUSERCOUNTS, () => {
  ...
  it('gets the number of Microsoft Teams daily unique users by device type for the given period',
    async () => {
      ...
      assert.strictEqual(requestStub.mock.lastCall[0].url, "https://graph.microsoft.com/v1.0/reports/getTeamsDeviceUsageUserCounts(period='D7')");
