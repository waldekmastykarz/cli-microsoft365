...
describe(commands.ADD, () => {
  ...
  it('uploads file to the root site collection, root site, default document library, root folder',
    async () => {
  ...
  it('uploads empty file to the root site collection, root site, default document library, root folder',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('uploads file to the root site collection, root site, default document library, root folder with trailing slash',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('uploads file to the root site collection, root site, default document library, sub folder',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('uploads file to the root site collection, root site, custom document library, root folder',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('uploads file to One Drive for Business, default doc lib, root folder',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('uploads file to a non-root site collection, doc lib, root folder',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('uploads file to a non-root site collection, doc lib, root folder without site lookup with siteUrl specified',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('returns error when resolving Graph URL for the file to be uploaded failed',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
  ...
  it('returns error when creating Graph upload session for the file to be uploaded failed',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        const url: string = opts.url as string;
