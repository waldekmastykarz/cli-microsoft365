...
describe(commands.M365GROUP_USER_REMOVE, () => {
  ...
  it('fails validation if neither the groupId nor the teamID are provided.',
    async () => {
  ...
  it('fails validation when both groupId and teamId are specified',
    async () => {
      jest.spyOn(cli, 'getSettingWithDefaultValue').mockClear().mockImplementation((settingName, defaultValue) => {
        if (settingName === settingsNames.prompt) {
          return false;
  ...
  it('passes validation when valid groupId and userName are specified',
    async () => {
      const actual = await command.validate({
        options: {
          teamId: '6703ac8a-c49b-4fd4-8223-28f0ac3a6402',
  ...
  it('prompts before removing the specified user from the specified Microsoft 365 Group when confirm option not passed',
    async () => {
  ...
  it('prompts before removing the specified user from the specified Team when confirm option not passed (debug)',
    async () => {
  ...
  it('aborts removing the specified user from the specified Microsoft 365 Group when confirm option not passed and prompt not confirmed',
    async () => {
  ...
  it('aborts removing the specified user from the specified Microsoft 365 Group when confirm option not passed and prompt not confirmed (debug)',
    async () => {
      const postSpy = jest.spyOn(request, 'delete').mockClear();
      jestUtil.restore(Cli.prompt);
      jest.spyOn(Cli, 'prompt').mockClear().mockImplementation().resolves({ continue: false });
  ...
  it('removes the specified owner from owners and members endpoint of the specified Microsoft 365 Group with accepted prompt',
    async () => {
  ...
  it('removes the specified owner from owners and members endpoint of the specified Microsoft 365 Group when prompt confirmed',
    async () => {
      let memberDeleteCallIssued = false;
  ...
  it('removes the specified member from members endpoint of the specified Microsoft 365 Group when prompt confirmed',
    async () => {
      let memberDeleteCallIssued = false;
  ...
  it('removes the specified owners from owners endpoint of the specified Microsoft 365 Group when prompt confirmed',
    async () => {
      let memberDeleteCallIssued = false;
  ...
  it('does not fail if the user is not owner or member of the specified Microsoft 365 Group when prompt confirmed',
    async () => {
      let memberDeleteCallIssued = false;
  ...
  it('stops removal if an unknown error message is thrown when deleting the owner',
    async () => {
      let memberDeleteCallIssued = false;
  ...
  it('correctly retrieves user but does not find the Group Microsoft 365 group',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if (opts.url === `https://graph.microsoft.com/v1.0/users/anne.matthews%40contoso.onmicrosoft.com/id`) {
          return {
  ...
  it('correctly retrieves user and handle error removing owner from specified Microsoft 365 group',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if (opts.url === `https://graph.microsoft.com/v1.0/users/anne.matthews%40contoso.onmicrosoft.com/id`) {
          return {
  ...
  it('correctly retrieves user and handle error removing member from specified Microsoft 365 group',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if (opts.url === `https://graph.microsoft.com/v1.0/users/anne.matthews%40contoso.onmicrosoft.com/id`) {
          return {
  ...
  it('correctly skips execution when specified user is not found',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
      ...
      jest.spyOn(request, 'delete').mockClear().mockImplementation().resolves();
