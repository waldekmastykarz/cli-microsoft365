...
describe(commands.M365GROUP_REPORT_ACTIVITYSTORAGE, () => {
  ...
  it('has correct name', () => {
    assert.strictEqual(command.name, commands.M365GROUP_REPORT_ACTIVITYSTORAGE);
  });
  ...
  it('get the reports', async () => {
    ...
    assert.strictEqual(requestStub.mock.lastCall[0].url, "https://graph.microsoft.com/v1.0/reports/getOffice365GroupsActivityStorage(period='D7')");
