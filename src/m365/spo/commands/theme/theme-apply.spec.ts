...
describe(commands.THEME_APPLY, () => {
  ...
  it('applies theme when correct parameters are passed (debug)', async () => {
    ...
    assert.strictEqual(postStub.mock.lastCall[0].url, 'https://contoso-admin.sharepoint.com/_vti_bin/client.svc/ProcessQuery');
    assert.strictEqual(postStub.mock.lastCall[0].headers['X-RequestDigest'], 'ABC');
  ...
  it('applies SharePoint theme (Blue) when correct parameters are passed',
    async () => {
  ...
  it('applies SharePoint theme (Orange) when correct parameters are passed',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        requests.push(opts);
  ...
  it('applies SharePoint theme (Red) when correct parameters are passed',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        requests.push(opts);
  ...
  it('applies SharePoint theme (Purple) when correct parameters are passed',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        requests.push(opts);
  ...
  it('applies SharePoint theme (Green) when correct parameters are passed',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        requests.push(opts);
  ...
  it('applies SharePoint theme (Gray) when correct parameters are passed',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        requests.push(opts);
  ...
  it('applies SharePoint theme (Dark Yellow) when correct parameters are passed',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        requests.push(opts);
  ...
  it('applies SharePoint theme (Dark Blue) when correct parameters are passed',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        requests.push(opts);
