...
describe(commands.M365GROUP_USER_SET, () => {
  ...
  it('passes validation when valid teamId, userName and role specified',
    async () => {
      const actual = await command.validate({
        options: {
          groupId: '6703ac8a-c49b-4fd4-8223-28f0ac3a6402',
  ...
  it('shows error when the specified user is not present in specified M365 Group',
    async () => {
  ...
  it('shows error when the specified user is not present in specified Microsoft Teams team',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if (opts.url === `https://graph.microsoft.com/v1.0/groups/00000000-0000-0000-0000-000000000000/owners?$select=id,displayName,userPrincipalName,userType`) {
          return {
  ...
  it('shows error when the specified user is already a member in specified M365 Group',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if (opts.url === `https://graph.microsoft.com/v1.0/groups/00000000-0000-0000-0000-000000000000/owners?$select=id,displayName,userPrincipalName,userType`) {
          return {
  ...
  it('shows error when the specified user is already a member in specified Microsoft Teams team',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if (opts.url === `https://graph.microsoft.com/v1.0/groups/00000000-0000-0000-0000-000000000000/owners?$select=id,displayName,userPrincipalName,userType`) {
          return {
  ...
  it('shows error when the specified user is already a owner in specified Microsoft 365 Group',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if (opts.url === `https://graph.microsoft.com/v1.0/groups/00000000-0000-0000-0000-000000000000/owners?$select=id,displayName,userPrincipalName,userType`) {
          return {
  ...
  it('shows error when the specified user is already a owner in specified Microsoft Teams team',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if (opts.url === `https://graph.microsoft.com/v1.0/groups/00000000-0000-0000-0000-000000000000/owners?$select=id,displayName,userPrincipalName,userType`) {
          return {
  ...
  it('correctly promotes specified member to owner in specified Microsoft 365 Group',
    async () => {
  ...
  it('correctly promotes specified member to owner in specified Microsoft Teams team (debug)',
    async () => {
      let promoteMemberIssued = false;
  ...
  it('correctly demote specified owner to member in specified Microsoft 365 Group',
    async () => {
  ...
  it('correctly demote specified owner to member in specified Microsoft 365 Group (debug)',
    async () => {
      let demoteOwnerIssued = false;
