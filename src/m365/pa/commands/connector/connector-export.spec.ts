...
describe(commands.CONNECTOR_EXPORT, () => {
  ...
  let writeFileSyncStub: jest.Mock;
  let mkdirSyncStub: jest.Mock;
  ...
  beforeAll(() => {
    ...
    mkdirSyncStub = jest.spyOn(fs, 'mkdirSync').mockClear().mockReturnValue('');
    writeFileSyncStub = jest.spyOn(fs, 'writeFileSync').mockClear().mockReturnValue();
  ...
  it('correctly handles error when connector information misses properties',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`providers/Microsoft.PowerApps/apis/shared_connector-201-5f20a1f2d8d6777a75-5fa602f410652f4dfa?api-version=2016-11-01&$filter=environment%20eq%20%27Default-5be1aa17-e6cd-4d3d-8355-01af3e607d4b%27%20and%20IsCustomApi%20eq%20%27True%27`) > -1) {
          return {
  ...
  it('skips downloading swagger if the connector information does not contain a swagger reference',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`providers/Microsoft.PowerApps/apis/shared_connector-201-5f20a1f2d8d6777a75-5fa602f410652f4dfa?api-version=2016-11-01&$filter=environment%20eq%20%27Default-5be1aa17-e6cd-4d3d-8355-01af3e607d4b%27%20and%20IsCustomApi%20eq%20%27True%27`) > -1) {
          return {
  ...
  it('skips downloading swagger if the connector information does not contain a swagger reference (debug)',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`providers/Microsoft.PowerApps/apis/shared_connector-201-5f20a1f2d8d6777a75-5fa602f410652f4dfa?api-version=2016-11-01&$filter=environment%20eq%20%27Default-5be1aa17-e6cd-4d3d-8355-01af3e607d4b%27%20and%20IsCustomApi%20eq%20%27True%27`) > -1) {
          return {
  ...
  it('skips downloading icon if the connector information does not contain icon URL',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`providers/Microsoft.PowerApps/apis/shared_connector-201-5f20a1f2d8d6777a75-5fa602f410652f4dfa?api-version=2016-11-01&$filter=environment%20eq%20%27Default-5be1aa17-e6cd-4d3d-8355-01af3e607d4b%27%20and%20IsCustomApi%20eq%20%27True%27`) > -1) {
          return {
  ...
  it('skips downloading icon if the connector information does not contain icon URL (debug)',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`providers/Microsoft.PowerApps/apis/shared_connector-201-5f20a1f2d8d6777a75-5fa602f410652f4dfa?api-version=2016-11-01&$filter=environment%20eq%20%27Default-5be1aa17-e6cd-4d3d-8355-01af3e607d4b%27%20and%20IsCustomApi%20eq%20%27True%27`) > -1) {
          return {
  ...
  it('passes validation when the specified output folder exists', async () => {
    jest.spyOn(fs, 'existsSync').mockClear().mockImplementation((folder) => folder.toString().indexOf('connector') < 0);
    const actual = await command.validate({ options: { environmentName: 'Default-d87a7535-dd31-4437-bfe1-95340acd55c5', name: 'shared_connector-201-5f20a1f2d8d6777a75-5fa602f410652f4dfa', outputFolder: '123' } }, commandInfo);
    assert.strictEqual(actual, true);
  });
