...
describe(commands.SITE_LIST, () => {
  ...
  beforeAll(() => {
    ...
    jest.spyOn(spo, 'getRequestDigest').mockClear().mockImplementation().resolves({ FormDigestValue: 'abc', FormDigestTimeoutSeconds: 1800, FormDigestExpiresAt: new Date(), WebFullUrl: 'https://contoso.sharepoint.com' });
  ...
  it('fails validation if includeOneDriveSites is specified together with the type option',
    async () => {
  ...
  it('fails validation if includeOneDriveSites is specified together with the webTemplate option',
    async () => {
  ...
  it('retrieves list of sites when no type and no filter specified',
    async () => {
  ...
  it('retrieves list of sites when no type and no filter specified (debug)',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`/_vti_bin/client.svc/ProcessQuery`) > -1) {
          if (opts.headers &&
  ...
  it('retrieves list of sites when type CommunicationSite is specified',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`/_vti_bin/client.svc/ProcessQuery`) > -1) {
          if (opts.headers &&
  ...
  it('retrieves list of all sites when results returned in multiple pages',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`/_vti_bin/client.svc/ProcessQuery`) > -1) {
          if (opts.headers &&
  ...
  it('retrieves list of sites when STS#0 type and no filter specified',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`/_vti_bin/client.svc/ProcessQuery`) > -1) {
          if (opts.headers &&
  ...
  it('retrieves list of sites when no filter and includeOneDriveSites is specified',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`/_vti_bin/client.svc/ProcessQuery`) > -1) {
          if (opts.headers &&
  ...
  it('retrieves list of sites when STS#0 webTemplate and filter specified',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`/_vti_bin/client.svc/ProcessQuery`) > -1) {
          if (opts.headers &&
