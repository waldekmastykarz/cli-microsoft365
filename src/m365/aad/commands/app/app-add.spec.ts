...
describe(commands.APP_ADD, () => {
  ...
  it('creates AAD app reg with just the name', async () => {
    jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
    jest.spyOn(request, 'patch').mockClear().mockImplementation().rejects('Issued PATCH request');
  ...
  it('creates AAD app reg for a web app with the specified redirect URIs',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
      jest.spyOn(request, 'patch').mockClear().mockImplementation().rejects('Issued PATCH request');
      jest.spyOn(request, 'post').mockClear().mockImplementation(async opts => {
  ...
  it('creates AAD app reg for a desktop app with the specified redirect URI',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
      jest.spyOn(request, 'patch').mockClear().mockImplementation().rejects('Issued PATCH request');
      jest.spyOn(request, 'post').mockClear().mockImplementation(async opts => {
  ...
  it('creates AAD app reg for a daemon app with specified Microsoft Graph application permissions',
    async () => {
  ...
  it('creates AAD app reg for a daemon app with specified Microsoft Graph application and delegated permissions',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('creates AAD app reg for a single-page app with specified Microsoft Graph delegated permissions',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('creates AAD app reg for a single-page app with specified Microsoft Graph delegated permissions (debug)',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('creates AAD app reg with Application ID URI set to a fixed value',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issued GET request');
  ...
  it('creates AAD app reg with Application ID URI set to a fixed value (debug)',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issued GET request');
      jest.spyOn(request, 'patch').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/applications/c0e63919-057c-4e6b-be6c-8662e7aec4eb' &&
  ...
  it('creates AAD app reg with Application ID URI set to a value with the appId token and a custom scope that can be consented by admins',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issued GET request');
      jest.spyOn(request, 'patch').mockClear().mockImplementation(async opts => {
  ...
  it('creates AAD app reg with Application ID URI set to a value with the appId token and a custom scope that can be consented by admins and users',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issued GET request');
      jest.spyOn(request, 'patch').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/applications/fe45ba27-a692-4b11-adf8-f4ec184ea3a5') {
  ...
  it('creates AAD app reg with a certificate using certificate file',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
      jest.spyOn(request, 'patch').mockClear().mockImplementation().rejects('Issued PATCH request');
      jest.spyOn(request, 'post').mockClear().mockImplementation(async opts => {
  ...
  it('creates AAD app reg with a certificate using base64 string',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
      jest.spyOn(request, 'patch').mockClear().mockImplementation().rejects('Issued PATCH request');
      jest.spyOn(request, 'post').mockClear().mockImplementation(async opts => {
  ...
  it('creates AAD app reg for a daemon app with specified Microsoft Graph permissions, including admin consent',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('returns error when retrieving information about service principals failed',
    async () => {
      ...
      jest.spyOn(request, 'patch').mockClear().mockImplementation().rejects('Issued PATCH request');
      jest.spyOn(request, 'post').mockClear().mockImplementation().rejects('Issued POST request');
  ...
  it('returns error when non-existent service principal specified in the APIs',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('returns error when non-existent permission scope specified in the APIs',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('returns error when creating the AAD app reg failed', async () => {
    jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
    jest.spyOn(request, 'patch').mockClear().mockImplementation().rejects('Issued PATCH request');
    jest.spyOn(request, 'post').mockClear().mockImplementation().rejects({ error: { message: 'An error has occurred' } });
  ...
  it('returns error when setting Application ID URI failed', async () => {
    jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issued GET request');
    jest.spyOn(request, 'patch').mockClear().mockImplementation().rejects({ error: { message: 'An error has occurred' } });
    jest.spyOn(request, 'post').mockClear().mockImplementation(async opts => {
      if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/applications' &&
        JSON.stringify(opts.data) === JSON.stringify({
          "displayName": "My AAD app",
  ...
  it('creates AAD app reg for a web app with service principal name with trailing slash',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('creates AAD app reg for a web app from a manifest with non-existent scope',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('creates AAD app reg for a web app from a manifest without info URLs',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('creates AAD app reg for a web app from a manifest with pre-authorized apps',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('creates AAD app reg for a web app from a manifest with public client flows enabled',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('creates AAD app reg for a web app from a manifest with public client flows disabled',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('creates AAD app reg for a web app from a manifest with secrets',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('creates AAD app reg for a web app from a manifest with app roles',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('creates AAD app reg for a web app from a manifest with app roles and specified Microsoft Graph application permissions',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it(`creates AAD app reg with just the name. Doesn't save the app info if not requested`,
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
      jest.spyOn(request, 'patch').mockClear().mockImplementation().rejects('Issued PATCH request');
      jest.spyOn(request, 'post').mockClear().mockImplementation(async opts => {
  ...
  it(`saves app info in the .m365rc.json file in the current folder when requested. Creates the file it doesn't exist`,
    async () => {
  ...
  it(`saves app info in the .m365rc.json file in the current folder when requested. Writes to the existing empty file`,
    async () => {
      let fileContents: string | undefined;
      let filePath: string | undefined;
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
  ...
  it(`saves app info in the .m365rc.json file in the current folder when requested. Adds to the existing file contents`,
    async () => {
      let fileContents: string | undefined;
      let filePath: string | undefined;
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
  ...
  it(`saves app info in the .m365rc.json file in the current folder when requested. Adds to the existing file contents (debug)`,
    async () => {
      let fileContents: string | undefined;
      let filePath: string | undefined;
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
  ...
  it(`doesn't save app info in the .m365rc.json file when there was error reading file contents`,
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
      jest.spyOn(request, 'patch').mockClear().mockImplementation().rejects('Issued PATCH request');
      jest.spyOn(request, 'post').mockClear().mockImplementation(async opts => {
  ...
  it(`doesn't save app info in the .m365rc.json file when file has invalid JSON`,
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
      jest.spyOn(request, 'patch').mockClear().mockImplementation().rejects('Issued PATCH request');
      jest.spyOn(request, 'post').mockClear().mockImplementation(async opts => {
  ...
  it(`doesn't fail execution when error occurred while saving app info`,
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
      jest.spyOn(request, 'patch').mockClear().mockImplementation().rejects('Issued PATCH request');
      jest.spyOn(request, 'post').mockClear().mockImplementation(async opts => {
      ...
      jest.spyOn(fs, 'existsSync').mockClear().mockReturnValue(false);
      jest.spyOn(fs, 'writeFileSync').mockClear().mockImplementation().throws(new Error('Error occurred while saving app info'));
  ...
  it('creates AAD app reg for a web app from a manifest with redirectUris and options overriding them',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('creates AAD app reg for a web app from a manifest with app roles and specified Microsoft Graph application permissions overriding them',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/servicePrincipals?$select=appId,appRoles,id,oauth2PermissionScopes,servicePrincipalNames') {
          return {
  ...
  it('creates AAD app reg with a certificate using base64 string, overriding manifest',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
      jest.spyOn(request, 'patch').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/applications/5b31c38c-2584-42f0-aa47-657fb3a84230' &&
  ...
  it('creates AAD app reg with a public client/redirectUris, overriding manifest',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
      jest.spyOn(request, 'patch').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/applications/5b31c38c-2584-42f0-aa47-657fb3a84230' &&
  ...
  it('creates AAD app reg with implicit flow enabled, overriding manifest',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
      jest.spyOn(request, 'patch').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/applications/5b31c38c-2584-42f0-aa47-657fb3a84230' &&
  ...
  it('creates AAD app reg with a custom scope, overriding manifest',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects('Issues GET request');
      jest.spyOn(request, 'patch').mockClear().mockImplementation(async opts => {
        if (opts.url === 'https://graph.microsoft.com/v1.0/myorganization/applications/5b31c38c-2584-42f0-aa47-657fb3a84230' &&
