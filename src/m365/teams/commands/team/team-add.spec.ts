...
describe(commands.TEAM_ADD, () => {
  ...
  it('passes validation if the template is not set and name and description is passed',
    async () => {
  ...
  it('creates Microsoft Teams team in the tenant when template is supplied and will continue fetching aadGroup when error is being thrown when wait is set to true',
    async () => {
      ...
      const aadGroupStub = jest.spyOn(aadGroup, 'getGroupById').mockClear().mockImplementation(async (groupId: string) => {
        if (firstCall) {
          firstCall = false;
          throw {
  ...
  it('creates Microsoft Teams team in the tenant when no template is supplied (verbose)',
    async () => {
      ...
      assert.deepEqual(requestStub.mock.calls[0][0].data, {
  ...
  it('creates Microsoft Teams team in the tenant when template is supplied (verbose)',
    async () => {
      const template = `
      {
        "template@odata.bind": "https://graph.microsoft.com/v1.0/teamsTemplates('standard')",
  ...
  it('creates Microsoft Teams team in the tenant when template and name is supplied (verbose)',
    async () => {
      const template = `
      {
        "template@odata.bind": "https://graph.microsoft.com/v1.0/teamsTemplates('standard')",
  ...
  it('creates Microsoft Teams team in the tenant when template and description is supplied (verbose)',
    async () => {
      const template = `
      {
        "template@odata.bind": "https://graph.microsoft.com/v1.0/teamsTemplates('standard')",
  ...
  it('creates Microsoft Teams team in the tenant when template, name and description is supplied (verbose)',
    async () => {
      const template = `
      {
        "template@odata.bind": "https://graph.microsoft.com/v1.0/teamsTemplates('standard')",
  ...
  it('creates Microsoft Teams team in the tenant when template, name and description is supplied and waits for command to complete (verbose)',
    async () => {
      const template = `
      {
        "template@odata.bind": "https://graph.microsoft.com/v1.0/teamsTemplates('standard')",
  ...
  it('correctly handles operation error when creating a Team when waiting for command to complete',
    async () => {
      const template = `
      {
        "template@odata.bind": "https://graph.microsoft.com/v1.0/teamsTemplates('standard')",
  ...
  it('correctly handles inProgress operation status when creating a Team and waiting for the command to complete',
    async () => {
      const template = `
      {
        "template@odata.bind": "https://graph.microsoft.com/v1.0/teamsTemplates('standard')",
