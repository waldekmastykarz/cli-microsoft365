...
describe(commands.CUSTOMACTION_CLEAR, () => {
  ...
  it('should user custom actions cleared successfully without prompting with confirmation argument',
    async () => {
  ...
  it('should prompt before clearing custom actions when confirmation argument not passed',
    async () => {
  ...
  it('should abort custom actions clear when prompt not confirmed',
    async () => {
  ...
  it('should clear custom actions when prompt confirmed', async () => {
    const postCallsSpy: jest.Mock = defaultPostCallsStub();
    const clearScopedCustomActionsSpy = jest.spyOn((command as any), 'clearScopedCustomActions').mockClear();
    ...
    try {
      ...
      assert(clearScopedCustomActionsSpy.calledWith(expect.objectContaining({
        webUrl: 'https://contoso.sharepoint.com'
      })) === true);
    }
    finally {
      jestUtil.restore((command as any)['clearScopedCustomActions']);
    }
  });

  it('should clearScopedCustomActions be called once when scope is Web',
    async () => {
      const postCallsSpy: jest.Mock = defaultPostCallsStub();
  ...
  it('should clearScopedCustomActions be called once when scope is Site',
    async () => {
      const postCallsSpy: jest.Mock = defaultPostCallsStub();
  ...
  it('should clearScopedCustomActions be called twice when scope is All',
    async () => {
      defaultPostCallsStub();
  ...
  it('should clearScopedCustomActions be calledTwice when scope is All',
    async () => {
      defaultPostCallsStub();

      const clearScopedCustomActionsSpy: jest.SpyInstance = jest.spyOn((command as any), 'clearScopedCustomActions').mockClear();
      const options = {
        webUrl: 'https://contoso.sharepoint.com',
        force: true
      };
  ...
  it('should the post calls be have the correct endpoint urls when scope is All',
    async () => {
      const postCallsSpy: jest.Mock = defaultPostCallsStub();
      ...
      await command.action(logger, { options: options } as any);
      assert(postCallsSpy.calledWith(expect.objectContaining({
