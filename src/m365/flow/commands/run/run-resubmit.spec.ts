...
describe(commands.RUN_RESUBMIT, () => {
  ...
  it('prompts before resubmitting the specified Microsoft Flow when confirm option not passed',
    async () => {
  ...
  it('aborts resubmitting the specified Microsoft Flow when confirm option not passed and prompt not confirmed',
    async () => {
  ...
  it('correctly handles specified Microsoft Flow not found when prompt confirmed',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation().rejects({
        "error": {
  ...
  it('correctly handles specified Microsoft Flow run not found when prompt confirmed',
    async () => {
  ...
  it('correctly getting triggername for the specified Microsoft Flow when prompt confirmed (debug)',
    async () => {
      ...
      assert.notStrictEqual(loggerLogToStderrSpy.mock.calls[1][0].indexOf('Retrieved trigger: manual'), -1);
      assert(getStub.called);
      assert(postStub.called);
    }
  );

  it('resubmits the specified Microsoft Flow run when confirm specified (debug)',
    async () => {
      const getStub = jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if ((opts.url as string).indexOf(`providers/Microsoft.ProcessSimple/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c6/flows/0f64d9dd-01bb-4c1b-95b3-cb4a1a08ac88/triggers?api-version=2016-11-01`) > -1) {
          if (opts.headers &&
      ...
      assert.strictEqual(getStub.mock.lastCall[0].url, 'https://management.azure.com/providers/Microsoft.ProcessSimple/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c6/flows/0f64d9dd-01bb-4c1b-95b3-cb4a1a08ac88/triggers?api-version=2016-11-01');
      assert.strictEqual(postStub.mock.lastCall[0].url, 'https://management.azure.com/providers/Microsoft.ProcessSimple/environments/Default-d87a7535-dd31-4437-bfe1-95340acd55c6/flows/0f64d9dd-01bb-4c1b-95b3-cb4a1a08ac88/triggers/manual/histories/08585981115186985105550762687CU161/resubmit?api-version=2016-11-01');
    }
  );
