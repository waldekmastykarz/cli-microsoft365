...
describe(commands.REPORT_USAGEACCOUNTCOUNTS, () => {
  ...
  it('has correct name', () => {
    assert.strictEqual(command.name, commands.REPORT_USAGEACCOUNTCOUNTS);
  });
  ...
  it('gets the report for the last week', async () => {
    ...
    assert.strictEqual(requestStub.mock.lastCall[0].url, "https://graph.microsoft.com/v1.0/reports/getOneDriveUsageAccountCounts(period='D7')");
