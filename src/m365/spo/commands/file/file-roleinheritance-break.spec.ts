...
describe(commands.FILE_ROLEINHERITANCE_RESET, () => {
  ...
  it('prompts before breaking role inheritance for the file when confirm option not passed',
    async () => {
  ...
  it('aborts breaking role inheritance for the file when confirm option is not passed and prompt not confirmed',
    async () => {
  ...
  it('breaks role inheritance clearing existing permissions on file by relative URL (debug)',
    async () => {
  ...
  it('breaks role inheritance keeping existing permissions on file by relative URL (debug)',
    async () => {
      jest.spyOn(request, 'post').mockClear().mockImplementation(async (opts) => {
  ...
  it('breaks role inheritance on file by Id when prompt confirmed',
    async () => {
  ...
  it('correctly handles error when breaking file role inheritance',
    async () => {
      const error = {
        error: {
          'odata.error': {
