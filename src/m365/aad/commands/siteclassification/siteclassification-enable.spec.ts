...
describe(commands.SITECLASSIFICATION_ENABLE, () => {
  ...
  it('sets Microsoft 365 Tenant siteclassification with usage guidelines url and guest usage guidelines url (debug)',
    async () => {
  ...
  it('sets Microsoft 365 Tenant siteclassification with usage guidelines url and guest usage guidelines url',
    async () => {
      let enableRequestIssued = false;
  ...
  it('sets Microsoft 365 Tenant siteclassification with usage guidelines url',
    async () => {
      let enableRequestIssued = false;
  ...
  it('sets Microsoft 365 Tenant siteclassification with guest usage guidelines url',
    async () => {
      let enableRequestIssued = false;
  ...
  it('Handles enabling when already enabled (conflicting errors)',
    async () => {
      jest.spyOn(request, 'get').mockClear().mockImplementation(async (opts) => {
        if (opts.url === `https://graph.microsoft.com/v1.0/groupSettingTemplates`) {
          return {
